...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0a1fa850-9247-4b77-a1ff-8b7d3d4493c5
```

> `0a1fa850-9247-4b77-a1ff-8b7d3d4493c5` is the password of the certificate, you can change it to any password you want.
